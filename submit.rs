...
const PARAMS: [Param; 8] = [
    ...
    Param {eff: 13, key_power: 34, key_exca_th: 1001, observe_power: 35, observe_exca_th: 66, connect_power: 31, connect_exca_th: 200, evalw: 12, fix_rate: 196, delta_range: 2, delta_cost_w: 1, atk_eval_rate: 1, },
