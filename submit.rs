...
const PARAMS: [Param; 8] = [
    ...
    Param {eff: 14, key_power: 82, key_exca_th: 801, observe_power: 75, observe_exca_th: 71, connect_power: 91, connect_exca_th: 100, evalw: 12, fix_rate: 201, delta_range: 2, delta_cost_w: 31, atk_eval_rate: 2, },
