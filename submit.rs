...
const PARAMS: [Param; 8] = [
    ...
    Param {eff: 14, key_power: 28, key_exca_th: 1001, observe_power: 15, observe_exca_th: 61, connect_power: 25, connect_exca_th: 240, evalw: 12, fix_rate: 101, delta_range: 2, delta_cost_w: 31, atk_eval_rate: 1, },
