...
// 1099755.2959999999 137469.41199999998
const PARAMS: [Param; 8] = [
    ...
    Param {eff: 17, key_power: 40, key_exca_th: 951, observe_power: 40, observe_exca_th: 46, connect_power: 43, connect_exca_th: 330, evalw: 12, fix_rate: 176, delta_range: 2, delta_cost_w: 10, atk_eval_rate: 1, },
    ...
    Param {eff: 14, key_power: 133, key_exca_th: 1401, observe_power: 90, observe_exca_th: 11, connect_power: 127, connect_exca_th: 50, evalw: 8, fix_rate: 76, delta_range: 1, delta_cost_w: 25, atk_eval_rate: 2, },
];
